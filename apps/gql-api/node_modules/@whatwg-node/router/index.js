...
function createRouter(options) {
    ...
    function addHandlersToMethod(method, path, ...handlers) {
        ...
        const pattern = new fetch.URLPattern({ pathname: fullPath });
    ...
    async function handleRequest(request, context) {
        ...
        function getParsedUrl() {
            if (!_parsedUrl) {
                _parsedUrl = new fetch.URL(request.url);
            }
            return _parsedUrl;
        }
    ...
    return server.createServerAdapter(routerBaseObject, (options === null || options === void 0 ? void 0 : options.RequestCtor) || fetch.Request);
}
